...
class EmployeSalaryController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('employe.salary.index',compact('section','month','salary','branch','account','method'));
    }
    ...
    public function paidSalary(Request $request,$id){
        ...
        $balance =  \Help::account($request->fk_account_id)->balance;
        if($balance<$request->paid_amount){
            return redirect()->back()->with('error','Your account has insufficient balance.');
        }
        try {
            $salary=EmployeSalarySheet::where('id',$id)->update([
