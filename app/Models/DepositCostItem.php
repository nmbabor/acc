...
class DepositCostItem extends Model
{
    ...
    protected $fillable = ['fk_deposit_id','fk_sub_category_id','description','total_amount','paid_amount','fk_loan_id']; 

    public function subCategory(){
        return $this->belongsTo(SubCategories::class,'fk_sub_category_id','id');
    }
    public function history(){
        return $this->hasOne(DepositHistoryItem::class,'fk_deposit_item_id','id');
    }
