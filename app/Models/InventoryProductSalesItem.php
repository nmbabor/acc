...
class InventoryProductSalesItem extends Model
{
    ...
    protected $fillable = ['fk_sales_id','fk_product_id','product_price_amount','product_wise_discount','cost_amount','sales_qty','product_paid_amount','small_qty','fk_model_id','inventory_item_id'];
