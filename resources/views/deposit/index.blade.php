                                        ...
                                        <div class='col-xs-12 col-sm-12 col-md-12 col-lg-12'>
                                            <table class="table table-bordered table-hover" id="table_auto">
                                                ...
                                                <tbody>
                                                    <tr>
                                                       <td>
                                                            <select id="sector_1" name="fk_sub_category_id[]" data-placeholder="- Select -" class="select select sectorSelect form-control" tabindex="10" required="required">
                                                                <option value="">Please choose</option>
