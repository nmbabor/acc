                        ...
                        {!! Form::open(array('route' => 'payment.store','class'=>'form-horizontal author_form','method'=>'POST','files'=>'true', 'id'=>'commentForm','role'=>'form','data-parsley-validate novalidate')) !!}
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6">
                                        <input name="client_name" required class="form-control" id="client" onfocus="autoComplete(this.id)" type="text"  placeholder="Pay to" />
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6">
                                        <select name="fk_account_id" data-placeholder="- Select account-" class="select form-control" id="fk_account_id" tabindex="10" required="required">
                                            ...
                                            <table class="table table-bordered table-hover" id="table_auto">
                                                <thead>
                                                    <tr>
                                                        ...
                                                        <th width="15%" id="loanIdLabel">Asset Age</th>
                                                ...
                                                <tbody>
                                                    <tr>
                                                        <td>
                                                            <select id="sector_1" name="fk_sub_category_id[]" class="select form-control sectorSelect" required="required">
                                                        ...
                                                        <td id="loanId_1"> 
                                                            <input  id="asset_1" type="number" min="0" step="any" name="asset_age[]" readonly placeholder="" class="form-control">
                                                        </td>
                                                        <td>
                                                            <input type="hidden" name="asset_type_id[]" id="asset_type_1">
                                    ...
                                    <div class='row'>   
                                        ...
                                        <div class='col-xs-12 col-sm-4 col-md-4 col-lg-4'>
                                            ...
                                            <div class="form-group transition_cul_section">
                                                ...
                                                <div class="input-group">
                                                    <div class="input-group-addon currency">৳</div>
                                                    <input value="0" type="number" max="{{Help::account(1)->balance}}" min="0" step="any" class="form-control" name="paid_amount" id="amountPaid" placeholder="Paid Amount" readonly>
                                                </div>
                                            </div>
                                            <div class="form-group transition_cul_section">
