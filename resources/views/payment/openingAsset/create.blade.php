                ...
                <div class="panel panel-inverse">
                    <div class="panel-heading">
                        <div class="panel-heading-btn">
                            <a class="btn btn-info btn-xs" href="{{URL::to('/opening-asset')}}">View All</a>
                        </div>
                        <h4 class="panel-title">Opening assets </h4>
                    </div>
                    <div class="panel-body">
                        {!! Form::open(array('route' => 'opening-asset.store','class'=>'form-horizontal author_form','method'=>'POST','role'=>'form','data-parsley-validate novalidate')) !!}
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6">
                                        <input class="form-control datepicker" type="text" id="Date" name="date" placeholder="date" data-parsley-required="true" value="{{date('d-m-Y')}}" />
                                    </div>
                                </div>
                             </div>
                                <!-- transition -->
                                            ...
                                            <table class="table table-bordered table-hover" id="table_auto">
                                                ...
                                                <tbody>
                                                    <tr>
                                                        <td>
                                                            <div id="sector">
                                                               {{Form::select('fk_sub_category_id[]',$subCategories,'',['class'=>'form-control','placeholder'=>'Select Sector','required'])}}
                                                            </div>
                                                        </td>
                                                        <td> 
