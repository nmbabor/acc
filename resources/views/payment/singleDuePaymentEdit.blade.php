                                    ...
                                    <div class='row'>   
                                        ...
                                        <div class='col-xs-12 col-sm-4 col-md-4 col-lg-4'>
                                            ...
                                            <div class="form-group transition_cul_section">
                                                ...
                                                <div class="input-group">
                                                    <div class="input-group-addon currency">৳</div>
                                                    <input name="total_paid" required max="{{Help::account($getPaymentData->fk_account_id)->balance}}" value="" type="number" min="0" step="any" class="form-control" id="amountPaid" placeholder="Paid Amount" readonly>
                                                </div>
                                            </div>
