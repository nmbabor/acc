                ...
                <div class="panel panel-inverse">
                    <div class="panel-heading">
                        <div class="panel-heading-btn">
                            ...
                            <a class="btn btn-success btn-xs" href="{{URL::to('/payment/create')}}">Add New Payment</a>
                        </div>
                        <h4 class="panel-title">Payment Page</h4>
                    </div>
                    <div class="panel-body">
                        {!! Form::open(array('route' => ['payment.update',$data->id],'class'=>'form-horizontal author_form','method'=>'PUT','files'=>'true', 'id'=>'commentForm','role'=>'form','data-parsley-validate novalidate')) !!}
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="hidden" name="fk_payment_id" value="{{ $data->id }}">
                                <!-- transition -->
                                            ...
                                            <table class="table table-bordered table-hover" id="table_auto">
                                                ...
                                                @if(isset($data->items))
                                                    ...
                                                    <tr>
                                                        ...
                                                        @else
                                                            <select  id="sector_{{$i}}" name="fk_sub_category_old_id[]" class=" form-control sectorSelect" required="required" >
                                                                <?php 
                                                        ...
                                                        @if($data->fk_loan_id==null)
                                                        <td>
                                                            <input  id="asset_{{$i}}" type="number" min="0" step="any" name="asset_age_old[]" placeholder="Asset age" value="{{$item->asset_age}}" {{($item->asset->type==1)?'':'readonly'}} class="form-control">
                                                        </td>
                                                        @endif
                                                        <td>

                                                            <input type="hidden" value="{{$item->asset_type_id}}" name="asset_type_id_old[]" id="asset_type_{{$i}}">
                                                            <input type="hidden" value="{{$item->history['id']}}" name="payment_history_id_old[]" >
                                    ...
                                    <div class='row'>   
                                        ...
                                        <div class='col-xs-12 col-sm-4 col-md-4 col-lg-4'>
                                            ...
                                            <div class="form-group transition_cul_section">
                                                ...
                                                <div class="input-group">
                                                    <div class="input-group-addon currency">৳</div>
                                                    <input value="<?php echo intval($data->total_paid);?>" type="number" min="0" max="{{Help::account($data->fk_account_id)->balance+$data->total_paid}}" step="0.1" class="form-control" name="total_paid" id="amountPaid" placeholder="Paid Amount" readonly>
                                                </div>
                                            </div>
                                            <div class="form-group transition_cul_section">
