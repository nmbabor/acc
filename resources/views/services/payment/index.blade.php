			    ...
			    <div class="col-md-12">
                    <div class="panel panel-inverse">
                        <div class="panel-heading">
                            ...
                            @endif
                                <a class="btn btn-info btn-xs" href="{{URL::to('/service-payment')}}">View All</a>
                        ...
                        @if(isset($client))
                        @if(count($allDue)>0)
                        {!! Form::open(array('route' => 'service-payment.store','class'=>'form-horizontal author_form','method'=>'POST','files'=>'true', 'id'=>'commentForm','role'=>'form','data-parsley-validate novalidate')) !!}
...
<script type="text/javascript">
    ...
    function loadDue(id){
        window.location='{{URL::to("/service-payment")}}/'+id;
    }
</script>
@endsection
