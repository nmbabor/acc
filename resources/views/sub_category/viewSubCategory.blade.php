                            ...
                            <table id="data-table" class="table table-striped table-bordered nowrap" width="100%">
                                ...
                                <?php $i++; ?>
                                    <tr class="odd gradeX">
                                        ...
                                        <td>{{($subCategory->type==1)?'Expense Sector':'Incoming Sector'}}</td> 
                                        <td>{{$subCategory->asset->name}}</td>
                                                    ...
                                                    {!! Form::open(array('route' => ['sub-category.update',$subCategory->id],'class'=>'form-horizontal author_form','method'=>'PUT','files'=>'true', 'id'=>'commentForm','role'=>'form','data-parsley-validate novalidate')) !!}
                                                        ...
                                                        <div class="modal-body">
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <div class="col-md-8 col-sm-8">
                                                                    {{Form::select('type',['1'=>'Expense sector','2'=>'Incoming sector'],$subCategory->type,['class'=>'form-control','placeholder'=>'Select Type','required'])}}
                                                                </div>
                                                            </div>
                                                            <div class="form-group">
                                                                <label class="control-label col-md-4 col-sm-4" for="sub_category_name">Sector Type * :</label>
                                                                <div class="col-md-8 col-sm-8">
                                                                    {{Form::select('asset_type_id',$type,$subCategory->asset_type_id,['class'=>'form-control','placeholder'=>'Select Option','required'])}}
                                                                </div>
                                                            </div>
                                                            <div class="form-group">
                                                                ...
                                                                <div class="col-md-3 col-sm-3">
                                                                    <div class="radio">
                                                                        <label>
                                                                            <input type="radio" name="status" value="1" id="radio-required" data-parsley-required="true" @if($subCategory->status=="1"){{"checked"}}@endif> Active
                                                                        </label>
                                                                    </div>
                                                                </div>
                                                                <div class="col-md-4 col-sm-4">
                                                                    <div class="radio">
                                                                        <label>
                                                                            <input type="radio" name="status" id="radio-required2" value="0" @if($subCategory->status=="0"){{"checked"}}@endif> Inactive
                                                                        </label>
                                                                    </div>
                                                                </div> 
                                                            </div>
