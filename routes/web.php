...
Route::group(['middleware' =>'auth'], function(){
	...
	Route::get('account-balance/{id}',function($id){
	 return Help::account($id)->balance;
    });
	...
	Route::post('employe-salary-paid/{id}', 'EmployeSalaryController@paidSalary');


	Route::get('payment-all','PaymentController@all');
	Route::get('deposit-all','DepositController@all');
	...
	Route::get('subcategory-asset-type/{id}','PaymentController@subCategoryAsset');
	Route::resource('opening-asset','OpeningAssetController');
	Route::get('payable-loan','BankLoanController@payable');
	Route::get('payable-loan-all','BankLoanController@payableAll');
	
	Route::get('receivable-loan','BankLoanController@receivable');
	Route::get('receivable-loan-all','BankLoanController@receivableAll');

	Route::get('payable-loan-check/{id}','BankLoanController@payableLoanCheck');
