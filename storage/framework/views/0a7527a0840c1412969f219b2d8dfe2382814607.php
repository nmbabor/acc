                ...
                <div class="panel panel-inverse">
                    <div class="panel-heading">
                        <div class="panel-heading-btn">
                            <a class="btn btn-info btn-xs" href="<?php echo e(URL::to('/deposit')); ?>"> View All Deposit List </a>
                            <a class="btn btn-success btn-xs" href="<?php echo e(URL::to('/deposit/create')); ?>"> Add New Create Deposit </a>
                        </div>
                        <h4 class="panel-title">Deposit Page </h4>
                    </div>
                    <div class="panel-body">
                        <?php echo Form::open(array('route' => ['deposit.update',$data->id],'class'=>'form-horizontal author_form','method'=>'PUT', 'id'=>'commentForm','role'=>'form','data-parsley-validate novalidate')); ?>
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="hidden" name="fk_deposit_id" value="<?php echo e($data->id); ?>">
                                <!-- transition -->
                                                ...
                                                <?php if(isset($data->items)): ?>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <?php endif; ?>
                                                            ...
                                                            <input type="hidden" value="<?php echo e($item->history['id']); ?>" name="deposit_history_id_old[]" >
                                                        </td>
