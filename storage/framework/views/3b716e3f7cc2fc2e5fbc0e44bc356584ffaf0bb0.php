                    ...
                    <div class="panel panel-inverse">
                        <div class="panel-heading">
                            <div class="panel-heading-btn">
                                <a class="btn btn-xs btn-info" href="<?php echo e(URL::to('/account-money-transfer')); ?>">Transfered List</a>
                            </div>
                            <h4 class="panel-title">Balance Transfer </h4>
                        </div>
                        <div class="panel-body">
                            <?php echo Form::open(array('route' => 'account-money-transfer.store','class'=>'form-horizontal author_form','method'=>'POST','files'=>'true', 'id'=>'commentForm','role'=>'form','data-parsley-validate novalidate')); ?>
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-8">
                                        <?php echo e(Form::select('branch_one',$branch,Auth::user()->fk_branch_id,['class'=>'form-control branch','id'=>'branchOne'])); ?>
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="form-group">
                                    <label class="control-label col-md-4">Branch :</label>
                                    <div class="col-md-8">
                                        <?php echo e(Form::select('branch_one',$branch,'',['class'=>'form-control branch','id'=>'branchTwo','required','placeholder'=>'Select Branch'])); ?>
                            ...
                            <div class="col-md-8 col-md-offset-2 border">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-8">
                                        <?php echo e(Form::select('fk_method_id',$methods,'3',['class'=>'form-control','id'=>'method','placeholder'=>'Select Method'])); ?>
    ...
    <script type="text/javascript">
        ...
        $('#branchOne').on('change',function(){
            var id =$(this).val();
            $('.branchOne').load('<?php echo e(URL::to("load-acoount")); ?>/'+id+'/1');
        });
        $('#branchTwo').on('change',function(){
            var id =$(this).val();
            $('.branchTwo').load('<?php echo e(URL::to("load-acoount")); ?>/'+id+'/2');
        })
    </script>
