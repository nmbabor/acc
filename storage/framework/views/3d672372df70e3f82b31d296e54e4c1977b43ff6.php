                ...
                <div class="panel panel-inverse">
                    <div class="panel-heading">
                        <div class="panel-heading-btn">
                            <a class="btn btn-xs btn-info" href="<?php echo e(URL::to('/deposit')); ?>">View All Deposit List</a>
                            <a class="btn btn-xs btn-info" href="<?php echo e(URL::to('/deposit')); ?>">View All Deposit List</a>
                        </div>
                    ...
                    <div class="col-md-6">
                        <table class="table table-bordered ">
                            ...
                            <tr>
                                <th>Client Name :</th>
                                <td><?php echo e($getDepositData->client_name); ?></td>
                            </tr>
                            <tr>
                                <th>Account : </th>
                                <td><?php echo e($getDepositData->account_name); ?></td>
                            </tr>
                    ...
                    <div class="col-md-6">
                        <table class="table table-bordered">
                            ...
                            <tr>
                                ...
                                <td><?php echo e($getDepositData->method_name); ?></td>
                            </tr>
                        ...
                        <?php echo Form::open(array('route' => ['due-deposit.update',$getDepositData->id],'class'=>'form-horizontal author_form','method'=>'PUT','files'=>'true', 'id'=>'commentForm','role'=>'form','data-parsley-validate novalidate')); ?>
                            ...
                            <div class="row">
                                ...
                                <input type="hidden" name="fk_deposit_id" value="<?php echo e($getDepositData->id); ?>">
                                <!-- transition -->
                                    ...
                                    <div class='row'>
                                        <div class='col-xs-12 col-sm-12 col-md-12 col-lg-12'>
                                            <table class="table table-bordered padding5" id="table_auto">
                                                ...
                                                <tbody>
                                                <?php if(isset($getDueDepositData)): ?>
                                                    <?php $i=0; ?>
                                                    <?php $__currentLoopData = $getDueDepositData; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $depositItem): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                        <?php $i++; ?>

                                                    <tr>
                                                        <td>
                                                        <?php echo e($depositItem->sub_category_name); ?>
                                                        ...
                                                        <td>
                                                            <?php echo e($depositItem->description); ?>

                                                            
                                                        </td>
                                                        <td>
                                                        <?php echo e($depositItem->total_amount); ?>

                                                            
                                                        </td>
                                                        <td>
                                                        <?php echo e($depositItem->paid_amount); ?>

                                                            
                                                        </td>
                                                        <td>
                                                          <?php echo e($depositItem->total_amount-$depositItem->paid_amount); ?>

                                                           <input type="hidden" name="last_due[]" value="<?php echo e($depositItem->total_amount-$depositItem->paid_amount); ?>"> 
                                                        </td>
                                                        <td>
                                                            <input type="number" min="0" max="<?php echo e($depositItem->total_amount-$depositItem->paid_amount); ?>" name="paid[]" id="paid_<?php echo $depositItem->id; ?>" class="form-control onChangeAmountPaid" onkeypress="return IsNumeric(event);" ondrop="return false;" onpaste="return false;" value="0" required>
                                                    ...
                                                    <tr class="active">
                                                        ...
                                                        <th><?php echo e($getDepositData->amount); ?></th>
                                                        <th><?php echo e($getDepositData->total_paid); ?></th>
                                                        <th><?php echo e($getDepositData->amount-$getDepositData->total_paid); ?>
