                    ...
                    <div class="panel panel-inverse">
                        <div class="panel-heading">
                            <div class="panel-heading-btn">
                                <a class="btn btn-info btn-xs" href="<?php echo e(URL::to('/payment/create')); ?>">Add New</a>
                            </div>
                            <h4 class="panel-title">Receivable Loan</h4>
                        </div>
...
<script type="text/javascript">
    $(function() {
        $('#all_data').DataTable( {
            processing: true,
            serverSide: true,
            ajax: '<?php echo URL::to("receivable-loan-all"); ?>',
            columns: [
