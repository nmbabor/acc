                ...
                <div class="panel panel-inverse">
                    ...
                    <div class="col-md-6">
                        <table class="table table-bordered ">
                            ...
                            <tr>
                                <th>Client Name :</th>
                                <td><?php echo e($getPaymentData->client_name); ?></td>
                            </tr>
                            <tr>
                                <th>Account : </th>
                                <td><?php echo e($getPaymentData->account_name); ?></td>
                            </tr>
                    ...
                    <div class="col-md-6">
                        <table class="table table-bordered">
                            ...
                            <tr>
                                ...
                                <td><?php echo e($getPaymentData->method_name); ?></td>
                            </tr>
                        
                        </table>
                    </div>
                        <?php echo Form::open(array('route' => ['due-payment.update',$getPaymentData->id],'class'=>'form-horizontal author_form','method'=>'PUT','files'=>'true', 'id'=>'commentForm','role'=>'form','data-parsley-validate novalidate')); ?>
                        ...
                        <div class="form-group col-md-6 pull-right">
                        	...
                        	<div class="form-group">
                                ...
                                <input type="hidden" name="fk_payment_id" value="<?php echo e($getPaymentData->id); ?>">
                                <!-- transition -->
                                    ...
                                    <div class='row'>
                                        <div class='col-xs-12 col-sm-12 col-md-12 col-lg-12'>
                                            <table class="table table-bordered padding5" id="table_auto">
                                                ...
                                                <tbody>
                                                <?php if(isset($getDuePaymentData)): ?>
                                                    <?php $i=0; ?>
                                                    <?php $__currentLoopData = $getDuePaymentData; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $paymentItem): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                        <?php $i++; ?>

                                                    <tr>
                                                        <td>
                                                        <?php echo e($paymentItem->sub_category_name); ?>
                                                        ...
                                                        <td>
                                                            <?php echo e($paymentItem->description); ?>

                                                            
                                                        </td>
                                                        <td>
                                                        <?php echo e($paymentItem->total_amount); ?>

                                                            
                                                        </td>
                                                        <td>
                                                        <?php echo e($paymentItem->paid_amount); ?>

                                                            
                                                        </td>
                                                        <td>
                                                          <?php echo e($paymentItem->total_amount-$paymentItem->paid_amount); ?>

                                                           <input type="hidden" name="last_due[]" value="<?php echo e($paymentItem->total_amount-$paymentItem->paid_amount); ?>"> 
                                                        </td>
                                                        <td>
                                                            <input type="number" min="0" max="<?php echo e($paymentItem->total_amount-$paymentItem->paid_amount); ?>" name="paid[]" id="paid_<?php echo $paymentItem->id; ?>" class="form-control onChangeAmountPaid" onkeypress="return IsNumeric(event);" ondrop="return false;" onpaste="return false;" value="0" required>
                                                    ...
                                                    <tr class="active">
                                                        ...
                                                        <th><?php echo e($getPaymentData->amount); ?></th>
                                                        <th><?php echo e($getPaymentData->total_paid); ?></th>
                                                        <th><?php echo e($getPaymentData->amount-$getPaymentData->total_paid); ?>
                                        ...
                                        <div class='col-xs-12 col-sm-4 col-md-4 col-lg-4'>
                                            ...
                                            <div class="form-group transition_cul_section">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <input value="<?php echo $getPaymentData->amount-$getPaymentData->total_paid;?>" type="number" name="last_total_due" min="0" step="any" class="form-control" id="total_amount" placeholder="Paid Amount" readonly>
                                                </div>
                                            </div>
                                            <div class="form-group transition_cul_section">
                                                ...
                                                <div class="input-group">
                                                    <div class="input-group-addon currency">৳</div>
                                                    <input name="total_paid" required max="<?php echo e(Help::account($getPaymentData->fk_account_id)->balance); ?>" value="" type="number" min="0" step="any" class="form-control" id="amountPaid" placeholder="Paid Amount" readonly>
                                                </div>
                                            </div>
