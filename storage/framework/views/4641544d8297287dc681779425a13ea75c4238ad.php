                        ...
                        <div class="panel-body">
                            <?php echo Form::open(array('route' => 'sub-category.store','class'=>'form-horizontal author_form','method'=>'POST','files'=>'true', 'id'=>'commentForm','role'=>'form','data-parsley-validate novalidate')); ?>
								...
								<div class="form-group">
									...
									<div class="col-md-6 col-sm-6">
										<?php echo e(Form::select('type',['1'=>'Expense sector','2'=>'Incoming sector'],'',['class'=>'form-control','placeholder'=>'Select Type','required'])); ?>
								...
								<div class="form-group">
									...
									<div class="col-md-6 col-sm-6">
										<?php echo e(Form::select('asset_type_id',$type,'',['class'=>'form-control','placeholder'=>'Select Option','required'])); ?>
