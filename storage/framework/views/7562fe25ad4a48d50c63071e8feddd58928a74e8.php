                                    ...
                                    <div class='row'>   
                                        ...
                                        <div class='col-xs-12 col-sm-4 col-md-4 col-lg-4'>
                                            ...
                                            <div class="form-group transition_cul_section">
                                                ...
                                                <div class="input-group">
                                                    <div class="input-group-addon currency">৳</div>
                                                    <input value="0" type="number" max="<?php echo e(Help::account(1)->balance); ?>" min="0" step="any" class="form-control" name="paid_amount" id="amountPaid" placeholder="Paid Amount" readonly>
                                                </div>
                                            </div>
                                            <div class="form-group transition_cul_section">
