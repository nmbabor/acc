                        ...
                        <div class="panel-body">
                            ...
                            <div class="modal fade" id="modal-dialog">
                                <div class="modal-dialog modal-lg">
                                    ...
                                    <?php echo Form::open(array('route' => 'employe-section.store','class'=>'form-horizontal author_form','method'=>'POST','files'=>'true', 'id'=>'commentForm','role'=>'form','data-parsley-validate novalidate')); ?>
	                                    ...
	                                    <tr class="odd gradeX">
	                                        ...
	                                        <!-- edit section -->
	                                            ...
	                                            <div class="modal fade" id="modal-dialog<?php echo $data->id;?>">
	                                                <div class="modal-dialog modal-lg">
	                                                    <div class="modal-content">
	                                                    <?php echo Form::open(array('route' => ['employe-section.update',$data->id],'class'=>'form-horizontal author_form','method'=>'PUT','files'=>'true', 'id'=>'commentForm','role'=>'form','data-parsley-validate novalidate')); ?>
	                                            ...
	                                            <!-- delete section -->
	                                            <?php echo Form::open(array('route'=> ['employe-section.destroy',$data->id],'method'=>'DELETE')); ?>
