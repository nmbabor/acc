		...
		<div id="content" class="content">
            ...
            <div class="invoice">
                <div class="invoice-company">
                    ...
                    <a class="printbtn btn btn-sm btn-info m-b-10" href='<?php echo e(URL::to("payment")); ?>'><i class="fa fa-list"></i> View All</a>
                    </span>
                ...
                <div id="customer_info" style="padding: 0px;">
                    <div class="row">
                        ...
                        <div class="customerInfo" style="width: 60%;float: left;">
                            <p><b>Name : </b><?php echo e($data->payment->client->client_name); ?></p>
                            <p><b>Address : </b><?php echo e($data->payment->client->address); ?></p>
                            <p><b>Mobile No :</b> <?php echo e($data->payment->client->mobile_no); ?></p>
                        </div>
                    ...
                    <div class="table-responsive">
                        <table class="table table-bordered">
                            ...
                            <? $i++; ?>
                                <tr>
                                    <td><?php echo e($i); ?></td>
                                    <td> <?php echo e($task->paymentItem->subCategory->sub_category_name); ?> </td>
                                    <td> <?php echo e($task->paymentItem->asset->name); ?> </td>
                                    
                                    <td><small><?php echo e($task->paymentItem->description); ?></small></td>
                                    <td style="text-align: right;"><?php echo e($task->last_due); ?>

                                    </td>
                                    <td style="text-align: right;"><?php echo e($task->paid); ?></td>
                                    <td style="text-align: right;"><?php echo e($task->last_due-$task->paid); ?></td>
                                    <? 
                            ...
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?> 
                                <tr class="info">
                                    ...
                                    <th style="text-align: right;"><?php echo e($total_amount); ?></th>
                                    <th style="text-align: right;"><?php echo e($paid); ?></th>
                                    <th style="text-align: right;"><?php echo e($totalDue); ?></th>
                                </tr>
                            </tbody>
                        </table>
                    </div>
