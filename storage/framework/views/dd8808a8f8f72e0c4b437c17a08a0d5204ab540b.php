                                    ...
                                    <div class='col-xs-12 col-sm-5 col-md-5 col-lg-5'>
                                        <span class="form-inlines">
                                                ...
                                                <div class="form-group aside_system">
                                                    ...
                                                    <div class="input-group col-md-8">
                                                        <div class="input-group-addon currency">৳</div>
                                                        <input value="" max="<?php echo e(Help::account(1)->balance); ?>" title="Balance: <?php echo e(Help::account(1)->balance); ?>" type="number" min="0" step="any" class="form-control" name="total_paid" id="subTotal" placeholder="Total Paid">
                                                    </div>
                                                </div>
